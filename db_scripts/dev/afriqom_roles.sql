...
CREATE TABLE `permissions` (
  `id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Unique identifier for each permission (auto incremented)',
  `role_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The role identifier for the permission',
  `model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The model name',
  `permissions` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Allowed permissions',
  `status` enum('active','inactive','deleted') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active' COMMENT 'Different states of a permission (default is active)',
...
CREATE TABLE `preferences` (
  `id` bigint NOT NULL COMMENT 'Unique identifier for each preference (auto incremented)',
  `user_id` bigint NOT NULL COMMENT 'The identifier for the user',
  `identifier` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Unique name for each preference',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The content for a given preference',
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'The date this entry was made (auto generated)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `roles` (
  `id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Unique identifier for each role (auto incremented)',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The name of the role',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'A description of the role',
  `status` enum('active','inactive','deleted') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active' COMMENT 'Different states of a user role (default is active)',
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'The date this entry was made (auto generated)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `user_roles_lookup` (
  ...
  `user_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The identifier for the user',
  `role_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The identifier for the user role'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Stand-in structure for view `vw_permissions`
-- (See below for the actual view)
--
CREATE TABLE `vw_permissions` (
...
--
-- Structure for view `vw_permissions`
--
DROP TABLE IF EXISTS `vw_permissions`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `vw_permissions`  AS SELECT `a`.`id` AS `id`, `a`.`role_id` AS `role_id`, `b`.`name` AS `name`, `a`.`model` AS `model`, `a`.`permissions` AS `permissions`, `a`.`status` AS `status`, `a`.`created_date` AS `created_date` FROM (`permissions` `a` join `roles` `b` on((`a`.`role_id` = `b`.`id`))) ;
...
--
ALTER TABLE `preferences`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for each preference (auto incremented)';
COMMIT;
